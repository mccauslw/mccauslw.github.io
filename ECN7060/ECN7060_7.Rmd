...
La densité de $Y$, en $y$, est de la même forme fonctionnelle de $\phi_Y(t)$, en $t$ :
\[
...
* Le théorème : Soit $\mu$ une mesure borélienne, $\phi(t)$ sa fonction caractéristique. Alors
