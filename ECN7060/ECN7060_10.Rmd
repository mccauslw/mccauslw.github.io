...
* Problèmes :
    ...
    - Calculer $R(\theta,\delta)$ même pour une seule valeur de $\theta$ est souvent infaisable. Un recours aux méthodes asymptotiques est habituel.
...
\[
\begin{aligned}
  \mathrm{Var}_\theta[W] &= \mathrm{Var}_\theta[E[W|T]] + E_\theta[\mathrm{Var_\theta[W|T]}] \\
  &= \mathrm{Var}_\theta[\phi(T)] + E_\theta[\mathrm{Var_\theta[W|T]}] \\
