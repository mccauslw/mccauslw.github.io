...
* Notes :
    ...
    * Avec cette généralité, on peut briser la symétrie des deux hypothèses.
...
\[
  \delta(x) = \begin{cases} a_0 & \frac{c_I}{c_{II}} \frac{\Pr[M=H_0]}{\Pr[M=H_1]} \frac{f_0(x)}{f_1(x)} \leq 1, \\ a_1 & \mbox{autrement}.
  \end{cases}
\]
