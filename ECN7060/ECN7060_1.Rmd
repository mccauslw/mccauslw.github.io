...
+ Il est cohérent ssi les prix vérifient les axiomes de probabilité.
...
[//]: Why doesn't diagonalization argument work on Q? Get a number not in Q.

## Démonstration que $\mathbb{Z}^2$ et $\mathbb{Q}$ sont dénombrables
...
[//]: Why Q countable matters: with uniform probability on interval, P of R is one; Q, 0
