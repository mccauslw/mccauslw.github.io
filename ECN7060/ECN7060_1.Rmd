...
* Espaces de probabilité, tribus, mesures, le théorème d’extension
* Variables aléatoires, fonctions de distribution, indépendance
* Espérance
* Convergence en probabilité, convergence presque sûre
* Fonctions caractéristiques, convergence en distribution et le théorème limite centrale
...
2. Participation, cours et séance TP : 5%
3. Examen final : 50%
...
[//]: Chance to ask questions before quiz
...
## Espaces de probablité $(\Omega, {\cal F}, P)$ dans un monde fini
...
[//]: Axioms of probability and no-arbitrage conditions: P as a price
...
+ Ensemble d'états du monde : $\Omega = \{\omega_1,\omega_2\}$
    - $\omega_1$: Le parti PLC gagne l'éléction fédérale prochaine
...
+ Contribution de Ramsey: accommoder l'aversion pour le risque et mesurer à la fois les judgements de probabilité et l'utilité.
...
[//]: Additivité et la loi d'un prix, absense d'arbtitrage
...
+ Difficultés conceptuelles :
    ...
    1. La possibilité des fréquences sont limites.
...
Par 3 et 4, ${\cal F}$ est un algèbre, pas forcément une tribu.
...
1. L'ensemble des fichiers (livres, dessins, audio, video)
...
[//]: Identify each as finite, countably infinite or uncountable
[//]: Mention Poisson distribution
...
[//]: Put 0, 1, pi, pi+1 in their equivalence classes.
...
3. une tribu ${\cal F}$ faisable mais assez riche qu'elle contient les événements d'intéret.
