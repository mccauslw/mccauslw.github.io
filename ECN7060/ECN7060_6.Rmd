...
## Exemple, suites de tirages au pile (P) ou face (F), partie I
...
\[
  X_n(\omega) = \begin{cases} 1 & r_n = F, \\ 0 & r_n = P. \end{cases}
\]
...
## Exemple, partie III, \textcolor{blue}{$n=4$}, \textcolor{red}{$n=8$}, \textcolor{green}{$n=16$}
