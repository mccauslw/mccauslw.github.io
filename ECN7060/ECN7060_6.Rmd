...
* cependant, si $X_n$ est une séquence de variables aléatoires sur $(\Omega,{\cal F},P)$, ${\cal L}_n = PX_n^{-1}$ est une séquence de mesures.
...
$$ \mu(\{x\}) = 0 \Rightarrow F_n(x) \to F(x). $$
* Preuve : fixez $x \in \mathbb{R}$, $\epsilon > 0$. Alors
