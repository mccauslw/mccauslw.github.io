...
$$ P[L(x) \leq \theta \leq U(x)|x] \quad \mbox{ou} \quad P[l\leq \theta \leq u|x] $$
    * Stratégie symmétrique : $L(x)$ et $U(x)$ sont les quantiles $\alpha/2$ et $1-\alpha/2$ de $\theta$, $U(x) - L(x)$ n'est pas forcément minimale
...
* Si $F_T$ est toujours inversible, $F_T(T|\theta) \sim U(0,1)$, une loi qui ne dépend pas de $\theta$.
...
* Considérer l'intervalle de confiance $[\theta_L, \theta_U]$ :
