...
Soit $X(\omega)$ et $Y(\omega)$ deux variables aléatoire sur le même espace de probabilité $(\Omega, {\cal F}, P)$. Soit $W(\omega) = X(\omega) + Y(\omega)$.
...
1. Fonctions sur $\Omega = \mathbb{R}$ avec un nombre de discontinuités dénombrable.
...
* Plus généralement, la fonction de répartition n'est pas forcément continue.
