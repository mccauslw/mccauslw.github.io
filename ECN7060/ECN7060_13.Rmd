...
* Même si la densité postérieure n'est pas bornée, la région où la densité postérieure est plus grande que le maximum local régulier a une probabilité négligable.
...
* Notes : on a besoin de
    ...
    * la négligeabilité du terme résiduel
