...
* Supposez que $X$ est ${\cal G}$-mesurable.
* $\{X \leq c\} \in {\cal G}$, tout $c$
...
* Preuve :
    ...
    * $XE[Y|{\cal G}] = E[XY|{\cal G}]$ avec probabilité 1.
    * Même chose pour $X$ simple (linéarité), positive (convergence dominée), générale.
...
* Statistiques exhaustives (sufficient), complètes, minimales, ancillaires (ou libres)
