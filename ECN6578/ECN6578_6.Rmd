...
- La loi $\alpha_0,\alpha_1|y,\omega_v,h_1,\ldots,h_T$ est presque gaussienne et on peut générer une proposition $(\alpha_0^*,\alpha_1^*)$ de l'approximation gaussienne. Une étape "accepter ou rejeter" "corrige" l'approximation.
- La loi $\omega_v|y,\alpha_0,\alpha_1,h_1,\ldots,h_T$ est un khi-carré avec un paramètre d'échelle. On peut tirer de cette loi directement.
- Il y a plusieurs façons de tirer $h$ de façon efficace. Les détail'expostion est trop détaillée pour le cours.