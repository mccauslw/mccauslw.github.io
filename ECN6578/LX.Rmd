...
1. La covariance entre le rendement du portefeuille $p$ sur le FMV et le portefeuille arbitraire avec poids $\omega$ est
$(g+\mu_ph)^\top\Omega\omega$.
Écrivez-la en forme $\lambda \omega^\top \mu + \gamma$, où $\lambda$ et $\gamma$ sont des fonctions de $\mu_p, A, B, C, D$. Remarquez que $\omega^\top \mu$ est le rendement moyen du portefeuille arbritraire.
Écrivez l'équation pour deux cas spéciaux, le portefeuille $p$ et le portefeuille $op$, pour obtenir (5.2.19) dans le manuel CLM.

\pagebreak

## Cours 8, 9, le 13 et le 20 mars
...
1. Obligations
1. Modèles de la structure à terme

#### Lectures

1. CLM Section 11.1 jusqu'à la page 438.
