...
1. Examen intra, le lundi 7 mars : 35%
1. Nombre aléatoire de quiz, en forme de devoir StudiUM : 15%
    a. quiz certain : le 17 janvier
    a. quiz aléatoires : les 10 dates possibles sont les 24, 31 janvier, les 7, 14, 21 février; les 14, 21, 28 mars; les 4, 11 avril. La probabilité d'un quiz est de 0,5.
    a. 8h30 - 8h45. La semaine prochaine seulement, aujourd'hui à 8h30 lundi.
1. Deux travaux pratiques de computation en R
    a. premier à remettre vendredi le 25 février avant minuit : 10%
    a. deuxième à remettre vendredi le 8 avril avant minuit : 5%
1. Examen final, le *jeudi* 14 avril : 35%

### Notes
- Les deux examens sont théoriques.
- Les travaux pratiques en R sont complémentaires des examens.
- Le premier travail consiste en les exercices pratiques données jusqu'au 21 février (inclusif) ; le deuxième, les exercices pratiques données jusqu'au 4 avril (inclusif).

## Documents au site web

### Documents

1. Lectures et exercices théoriques (organisées par cours)
...
1. Plan de cours
1. Diapos en pdf
1. Vidéos (enregistrements des réunions zoom)
...
- Chaque membre de l'équipe soumet le même travail.
...
- Le code source de ces diapos se trouve au site web du cours.
