...
- Participants
    ...
    - Firmes (financement des projets, gérance du risque)
    - Gouvernement (financement des dépenses et des transferts)
...
- Notes
    ...
    * Les rendements sont plus "stationnaires" que les prix.
...
* Avantage aux rendements simples par rapport aux log rendements pour l'analyse dans la coupe transversale.
...
1. Placer 100 \$ en proportions $(\omega_1,\omega_2,\omega_3) = (0.5, 0.2, 0.3)$
    - C.-à-d. placer 50 \$ à l'actif 1, 20 \$ à l'actif 2, 30 \$ à l'actif 3.
...
1. Placer 100 \$ en actif 1, 2 ou 3 avec probabilités 0.5, 0.2, 0.3.
    - C.-à-d. placer 100 \$ en actif 1 avec probabilité 0.5, 100 \$ en actif 2 avec p. 0.2, etc.
...
- Exemple 1: $Y$ est le rendement d'une action, $X$ indique l'industrie.
- Exemple 2: $Y$ est le rendement d'un actif, $X$ est une mesure de la volatilité.
...
1. Télécharger R et R Studio.
2. Créer un fichier HTML à partir du gabarit R Markdown.
