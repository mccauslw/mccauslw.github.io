...
1. Deux travaux pratiques de computation en R
    a. premier à remettre le 24 février avant minuit : 10%
    a. deuxième à remettre le 8 avril avant minuit : 10%
...
- Le premier travail consiste en les exercices pratiques données jusqu'au 10 février (inclusif) ; le deuxième, les exercices pratiques données jusqu'au 30 mars (inclusif).
...
- Notes :
    ...
    * Ils dépendent tous de l'unité du temps.
