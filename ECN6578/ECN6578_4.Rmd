...
- En réalité, on observe un échantillon $r_1,\ldots,r_T$ et recouvrit $a_1,\ldots,a_T$ seulement de façon approximative.
...
Un peu inflexible.
* L'aplatissement, s'il existe, est de $3(1-\alpha_1^2)/(1-3\alpha_1^2) > 3$.
