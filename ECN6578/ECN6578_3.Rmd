...
1. Il est très utile de définir un processus $r_t$ en termes d'une transformation d'un bruit blanc $a_t$ telle que la valeur $r_t$ dépend seulement du passé ($r_{t-1}, a_{t-1}, r_{t-2}, a_{t-2}, \ldots$) et *l'innovation* $a_t$.
