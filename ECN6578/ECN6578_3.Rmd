...
- Supposons que $\mu=0$, $\phi$ et $\sigma_a^2 \equiv \mathrm{Var}[a_t]$ sont donnés, $|\phi| < 0$.
...
* Cette équation en forme réduite pour $\gamma_k$ révèle les ailes de la fonction d'autocorrélation : $\gamma_k \approx c_i \omega_i^k$ pour $i$ tel que $\omega_i$ est minimal.
