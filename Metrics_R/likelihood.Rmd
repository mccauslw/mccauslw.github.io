...
If we repeat the computational exercise with the same number of samples (experiments) but each with a larger sample size $n=1000$, we get the following log likelihood and score functions.
