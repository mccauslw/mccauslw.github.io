...
+ Notes:
    ...
    + Concepts dérivés : équilibre efficace? prix efficace?
...
+ Par exemple, écrire un contrat enforcé par un tierce parti qui oblige un joueur à payer 5 dollars à l'autre s'il joue $D$.
+ Le jeu devient
...
![Le contrat des villageois de Xiaogang](figures/China_contract.jpg){width=50%}
