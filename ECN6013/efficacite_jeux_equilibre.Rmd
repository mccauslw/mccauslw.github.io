...
+ On considère ici le problème du planificateur social, pour trouver une allocation efficace.
...
* Chaque joueur a le même ensemble d'actions faisable
* $(a,a)$ est un équilibre de Nash, pour chaque action $a$
* Choix simultanés

L'existence de plusieurs équilibres de Nash purs ne suffit pas : le jeu de F-C a deux équilibrez de Nash.
