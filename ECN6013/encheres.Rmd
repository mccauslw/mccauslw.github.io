...
* Dans le cas des valeurs communes, $E_i[v] \neq E_i[v|E_j[v]]$ est possible : un joueur apprend quelque chose sur la valeur en découvrant la valeur espérée d'un autre joueur.
